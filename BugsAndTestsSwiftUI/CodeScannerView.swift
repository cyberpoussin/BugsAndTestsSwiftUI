...
public struct CodeScannerView: UIViewControllerRepresentable {
    ...
    public class ScannerViewController: UIViewController {
        ...
        private lazy var viewFinder: UIImageView? = {
            guard let image = UIImage(named: "viewfinder") else {
                print("no viewfinder image file")
                return nil
            }
    ...
    private var simulatedDatas: [String] = []
    public var simulatedData: String {
        simulatedDatas.randomElement() ?? "nothing"
    }
    public var completion: (Result<String, ScanError>) -> Void

    public init(codeTypes: [AVMetadataObject.ObjectType], scanMode: ScanMode = .once, showViewfinder: Bool = false, scanInterval: Double = 2.0, simulatedDatas: [String] = [], completion: @escaping (Result<String, ScanError>) -> Void) {
        self.codeTypes = codeTypes
        self.scanMode = scanMode
        self.showViewfinder = showViewfinder
        self.scanInterval = scanInterval
        self.simulatedDatas = simulatedDatas
